...
| **Step 4** | At each stop start, before selecting collection | Read → `OPTIMIZATIONS.md` → Issue 2 (Reference File + travel.js) |
...
- User says "cancel auto-travel" or "adjust plan" → provide settings panel
...
1. ✅ Read `OPTIMIZATIONS.md` → Issue 2 (Reference File + travel.js usage)
